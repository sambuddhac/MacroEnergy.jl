...
function add_planning_variables!(e::AbstractEdge,model::Model)
    ...
    e._new_capacity =  [@variable(model,lower_bound=0.0,base_name="vNEWCAPEDGE_$(commodity_type(e))_$(e.r_ID)")];

    e._capacity = [@variable(model,lower_bound=0.0,base_name="vCAPEDGE_$(commodity_type(e))_$(e.r_id)")];
...
function add_operation_variables!(e::AbstractEdge,model::Model)
    ...
    g._flow = @variable(model,[t in time_interval(g)],lower_bound=0.0,base_name="vFLOW_$(commodity_type(g))_$(g.r_id)")
