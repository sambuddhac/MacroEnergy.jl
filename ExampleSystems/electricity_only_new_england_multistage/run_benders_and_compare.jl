...
benders_optimizers = Dict(
    :planning => MacroEnergy.create_optimizer(Gurobi.Optimizer, ("Method" => 2, "Crossover" => 0, "BarConvTol" => 1e-3)),
    :subproblems => MacroEnergy.create_optimizer(Gurobi.Optimizer, ("Method" => 2, "Crossover" => 1, "BarConvTol" => 1e-3)),
)
mono_optimizer = MacroEnergy.create_optimizer(Gurobi.Optimizer, ("Method" => 2, "Crossover" => 0, "BarConvTol" => 1e-3))
