...
function add_fuel_to_assets!(assets::Dict{Symbol,AbstractAsset}, fuel_data::Dict{Symbol,Vector{Float64}}, co2_emission::AbstractDict{Symbol,Any})
    add_fuel_to_tedges!(tedges(assets), fuel_data, co2_emission)
    return nothing
end 

function add_fuel_to_tedges!(tedges::Dict{Symbol,Edge}, fuel_data::Dict{Symbol,Vector{Float64}}, co2_emission::AbstractDict{Symbol,Any})
