...
!!! tip "Default constraints"
    The only **default constraint** for the edges of the fuel cell asset is the [Capacity constraint](@ref capacity_constraint_ref) applied to the electricity edge. 
